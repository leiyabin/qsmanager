...
<?php $this->beginBlock('breadcrumb');//面包屑导航 ?>
    <div class="pageheader" style="height: 50px;padding-top: 10px">
        <h2><span style="font-style: normal">旅居楼盘</span>
...
<?php $this->endBlock(); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" style="width: 12%">城市/地区
                    <fond style="color: red">*</fond>
                </label>
                <div class="col-sm-6 dropdown" style="float:left; width: 296px;">
                    <button style="width: 230px;" class="btn btn-default dropdown-toggle" type="button" tag="0"
                            id="dropdownMenu1"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php foreach (\app\consts\HouseConst::$room_num as $key => $name): ?>
                        <label>
                            <input type="checkbox" value="<?= $key ?>" name="jiju"><?= $name ?>
                        </label>
                    <?php endforeach; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="number" name="min_square" class="form-control" style="width: 450px; display: inline">平方米
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="number" name="max_square" class="form-control" style="width: 450px; display: inline">平方米
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6" style="width: 700px;">
                    ...
                    <input type="hidden" name="banner_img_url">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="hidden" name="loupan_img_url">
                </div>
            </div>
            <div class="form-group">
